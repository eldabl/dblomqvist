 ...
 */
function silviamedia_form_install_configure_form_alter(&$form, $form_state) {

  // Pre-populate some fields in configure site form.
  $form['site_information']['site_name']['#default_value'] = 'Silvia Media'; //$_SERVER['SERVER_NAME'];
  $form['site_information']['site_mail']['#default_value'] = 'admin@nodeone.se';
  $form['admin_account']['account']['name']['#default_value'] = 'admin';
  $form['admin_account']['account']['mail']['#default_value'] = 'admin@nodeone.se';
